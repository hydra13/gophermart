...
// UserServiceMock implements mm_loginhandler.UserService
type UserServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcLogin          func(ctx context.Context, login string, password string) (i1 int64, err error)
...
// NewUserServiceMock returns a mock for mm_loginhandler.UserService
...
func (mmLogin *mUserServiceMockLogin) Expect(ctx context.Context, login string, password string) *mUserServiceMockLogin {
	...
	mmLogin.defaultExpectation.params = &UserServiceMockLoginParams{ctx, login, password}
...
// ExpectLoginParam2 sets up expected param login for UserService.Login
func (mmLogin *mUserServiceMockLogin) ExpectLoginParam2(login string) *mUserServiceMockLogin {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("UserServiceMock.Login mock is already set by Set")
	}
...
func (mmLogin *mUserServiceMockLogin) Inspect(f func(ctx context.Context, login string, password string)) *mUserServiceMockLogin {
...
func (mmLogin *mUserServiceMockLogin) Return(i1 int64, err error) *UserServiceMock {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("UserServiceMock.Login mock is already set by Set")
	}
	...
	mmLogin.defaultExpectation.results = &UserServiceMockLoginResults{i1, err}
...
func (mmLogin *mUserServiceMockLogin) Set(f func(ctx context.Context, login string, password string) (i1 int64, err error)) *UserServiceMock {
	if mmLogin.defaultExpectation != nil {
...
// Then helper
func (mmLogin *mUserServiceMockLogin) When(ctx context.Context, login string, password string) *UserServiceMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("UserServiceMock.Login mock is already set by Set")
	}
	...
	expectation := &UserServiceMockLoginExpectation{
		mock:               mmLogin.mock,
		params:             &UserServiceMockLoginParams{ctx, login, password},
...
func (e *UserServiceMockLoginExpectation) Then(i1 int64, err error) *UserServiceMock {
	e.results = &UserServiceMockLoginResults{i1, err}
	return e.mock
}
...
// Login implements mm_loginhandler.UserService
func (mmLogin *UserServiceMock) Login(ctx context.Context, login string, password string) (i1 int64, err error) {
	...
	mm_params := UserServiceMockLoginParams{ctx, login, password}
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockLoginParams{ctx, login, password}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.login != nil && !minimock.Equal(*mm_want_ptrs.login, mm_got.login) {
				mmLogin.t.Errorf("UserServiceMock.Login got unexpected parameter login, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmLogin.t.Fatalf("Unexpected call to UserServiceMock.Login. %v %v %v", ctx, login, password)
	return
}
