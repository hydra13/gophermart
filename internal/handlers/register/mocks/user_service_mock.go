...
// UserServiceMock implements mm_registerhandler.UserService
type UserServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcRegister          func(ctx context.Context, login string, password string) (i1 int64, err error)
	funcRegisterOrigin    string
	inspectFuncRegister   func(ctx context.Context, login string, password string)
	afterRegisterCounter  uint64
	beforeRegisterCounter uint64
	RegisterMock          mUserServiceMockRegister
}

// NewUserServiceMock returns a mock for mm_registerhandler.UserService
...
func (mmRegister *mUserServiceMockRegister) Expect(ctx context.Context, login string, password string) *mUserServiceMockRegister {
	...
	mmRegister.defaultExpectation.params = &UserServiceMockRegisterParams{ctx, login, password}
...
// ExpectLoginParam2 sets up expected param login for UserService.Register
func (mmRegister *mUserServiceMockRegister) ExpectLoginParam2(login string) *mUserServiceMockRegister {
	if mmRegister.mock.funcRegister != nil {
		mmRegister.mock.t.Fatalf("UserServiceMock.Register mock is already set by Set")
	}
	...
	mmRegister.defaultExpectation.paramPtrs.login = &login
	mmRegister.defaultExpectation.expectationOrigins.originLogin = minimock.CallerInfo(1)

	return mmRegister
}

// ExpectPasswordParam3 sets up expected param password for UserService.Register
func (mmRegister *mUserServiceMockRegister) ExpectPasswordParam3(password string) *mUserServiceMockRegister {
	if mmRegister.mock.funcRegister != nil {
		mmRegister.mock.t.Fatalf("UserServiceMock.Register mock is already set by Set")
	}
...
func (mmRegister *mUserServiceMockRegister) Inspect(f func(ctx context.Context, login string, password string)) *mUserServiceMockRegister {
...
func (mmRegister *mUserServiceMockRegister) Set(f func(ctx context.Context, login string, password string) (i1 int64, err error)) *UserServiceMock {
	if mmRegister.defaultExpectation != nil {
...
// Then helper
func (mmRegister *mUserServiceMockRegister) When(ctx context.Context, login string, password string) *UserServiceMockRegisterExpectation {
	if mmRegister.mock.funcRegister != nil {
		mmRegister.mock.t.Fatalf("UserServiceMock.Register mock is already set by Set")
	}
	...
	expectation := &UserServiceMockRegisterExpectation{
		...
		params:             &UserServiceMockRegisterParams{ctx, login, password},
...
// Register implements mm_registerhandler.UserService
func (mmRegister *UserServiceMock) Register(ctx context.Context, login string, password string) (i1 int64, err error) {
	...
	if mmRegister.inspectFuncRegister != nil {
		mmRegister.inspectFuncRegister(ctx, login, password)
	}

	mm_params := UserServiceMockRegisterParams{ctx, login, password}
	...
	if mmRegister.RegisterMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockRegisterParams{ctx, login, password}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.login != nil && !minimock.Equal(*mm_want_ptrs.login, mm_got.login) {
				mmRegister.t.Errorf("UserServiceMock.Register got unexpected parameter login, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRegister.RegisterMock.defaultExpectation.expectationOrigins.originLogin, *mm_want_ptrs.login, mm_got.login, minimock.Diff(*mm_want_ptrs.login, mm_got.login))
			}
	...
	if mmRegister.funcRegister != nil {
		return mmRegister.funcRegister(ctx, login, password)
	}
	mmRegister.t.Fatalf("Unexpected call to UserServiceMock.Register. %v %v %v", ctx, login, password)
	return
}
